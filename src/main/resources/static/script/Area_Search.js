    ...
    const radios = document.querySelectorAll('input[name="category"]:checked');
    ...
    const apiUrl = `http://localhost:8080/touristSpot/Json/api/tourist-info?region=${region}&sigungu=${sigungu}&contentTypeId=${contentTypeId}`;
